...
const ComapnyCard = ({
  ...
  return (
    <div className="bg-white w-full rounded-lg flex  items-center justify-between  px-[25px] py-5 shadow-sm cursor-pointer ">
...
Compnies.getLayout = function getLayout(page: ReactElement) {
